      ...
      <div class="main clearfix">
        <div class="main-left">
          <div class="border-container">
            ...
            <div id="radar">
              <Graph width="100%" height="100%" url="/FindAvgLogisticsBodyIndex" />
            </div>
          ...
          <div class="border-container">
            ...
            <div id="graduateyear">
              <Graph1
                width="100%"
                height="100%"
                nanshenurl="/FindLogisticsMSleepReach"
                nushenurl="/FindLogisticsFSleepReach"
              />
            </div>
            <ul class="three-pie clearfix">
              <li>
                ...
                <div id="sexrate">
                  <Graph2 width="100%" height="100%" url="/FindLogisticsMotion" />
                </div>
              </li>
              <li>
                <!--                <span class="name-title">各年龄段心率分布</span>-->
                <div id="householdrate">
                  <Graph3 width="100%" height="100%" url="/FindLogisticsFever" />
                </div>
              </li>
            </ul>
            <span class="top-left border-span"></span>
        ...
        <div class="main-middle">
          <div class="border-container">
            ...
            <div id="mapadd">
              <Graph9 width="100%" height="100%" url="/FindLogisticsSportsReach" />
            </div>
            <span class="top-left border-span"></span>
            <span class="top-right border-span"></span>
            <span class="bottom-left border-span"></span>
          ...
          <div class="border-container">
            <ul class="teacher-pie clearfix">
              <li>
                ...
                <div id="courserate">
                  <Graph4 width="100%" height="100%" url="/FindLogisticsAvgStepByAge" />
                </div>
              </li>
              <li>
                <div class="name-title">肥胖率分布占比</div>
                <div id="professionrate">
                  <Graph5 width="100%" height="100%" url="/FindLogisticsFatPercentage" />
                </div>
              </li>
            </ul>
            <div class="name-title" style="position: relative; top: 10px"> 学生每个月平均步数 </div>
            <div id="changedetail">
              <Graph6 width="100%" height="100%" url="/FindLogisticsEveryMonthAvgStep" />
            </div>
            <span class="top-left border-span"></span>
            <span class="top-right border-span"></span>
            <span class="bottom-left border-span"></span>
          ...
          <div class="border-container">
            ...
            <div id="juniorservice">
              <Graph7
                width="100%"
                height="100%"
                nanshenurl="/FindLogisticsMEveryWeekWarning"
                nushenurl="/FindLogisticsFEveryWeekWarning"
              />
            </div>
            <span class="top-left border-span"></span>
            <span class="top-right border-span"></span>
          ...
          <div class="border-container">
            ...
            <div id="edubalance">
              <Graph8
                width="100%"
                height="100%"
                nanshenurl="/FindLogisticsMEveryFeverSum"
                nushenurl="/FindLogisticsFEveryFeverSum"
              />
            </div>
            <span class="top-left border-span"></span>
            <span class="top-right border-span"></span>
